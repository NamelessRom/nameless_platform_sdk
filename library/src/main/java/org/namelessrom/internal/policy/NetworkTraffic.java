package org.namelessrom.internal.policy;
...
public class NetworkTraffic extends TextView {
    ...
    @SuppressLint("HandlerLeak") private final Handler mTrafficHandler = new Handler() {
        @Override
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(NamelessSettings.System.getUriFor(
                    NamelessSettings.System.NETWORK_TRAFFIC_STATE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(NamelessSettings.System.getUriFor(
                    NamelessSettings.System.NETWORK_TRAFFIC_AUTOHIDE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(NamelessSettings.System.getUriFor(
                    NamelessSettings.System.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(NamelessSettings.System.getUriFor(
                    NamelessSettings.System.NETWORK_TRAFFIC_COLOR),
                    false, this, UserHandle.USER_ALL);
        }
    ...
    private void updateSettings() {
        ...
        mAutoHide = NamelessSettings.System.getIntForUser(resolver,
                NamelessSettings.System.NETWORK_TRAFFIC_AUTOHIDE, 0,
                UserHandle.USER_CURRENT) == 1;

        mAutoHideThreshold = NamelessSettings.System.getIntForUser(resolver,
                NamelessSettings.System.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD, 10,
                UserHandle.USER_CURRENT);

        mState = NamelessSettings.System.getIntForUser(resolver,
                NamelessSettings.System.NETWORK_TRAFFIC_STATE, 0,
                UserHandle.USER_CURRENT);

        int networkTrafficColor = NamelessSettings.System.getIntForUser(resolver,
                NamelessSettings.System.NETWORK_TRAFFIC_COLOR, -2,
                UserHandle.USER_CURRENT);

        if (networkTrafficColor == Integer.MIN_VALUE || networkTrafficColor == -2) {
            networkTrafficColor = DEFAULT_COLOR;
        }

        if (networkTrafficColor != mNetworkTrafficColor) {
            mNetworkTrafficColor = networkTrafficColor;
    ...
    private void updateTrafficDrawable() {
        ...
        if (intTrafficDrawable != 0) {
            drw = getContext().getDrawable(intTrafficDrawable);
            if (drw != null) {
