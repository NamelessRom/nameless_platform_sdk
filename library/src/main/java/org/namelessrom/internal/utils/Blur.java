package org.namelessrom.internal.utils;
...
public class Blur {
    ...
    private static Boolean useStackBlur = null;

    public static Bitmap blurBitmap(Context context, Bitmap bmp, int radius) {
        if (useStackBlur == null) {
            useStackBlur = context.getResources().getBoolean(R.bool.config_use_stackblur);
        }
        if (useStackBlur) {
