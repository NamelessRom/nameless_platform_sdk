...
/**
 * NamelessSettings contains Nameless specific preferences in System, Secure, and Global.
 */
public final class NamelessSettings {
    private static final String TAG = "NamelessSettings";
    private static final boolean LOCAL_LOGV = false;

    public static final String AUTHORITY = "namelesssettings";

    public static class NamelessSettingNotFoundException extends AndroidException {
        public NamelessSettingNotFoundException(String msg) {
            super(msg);
        }
    }
    ...
    /**
     * @hide - Private call() method on NamelessSettingsProvider to migrate Nameless settings
     */
    public static final String CALL_METHOD_MIGRATE_SETTINGS = "migrate_settings";

    /**
     * @hide - Private call() method on NamelessSettingsProvider to migrate Nameless settings for a user
     */
    ...
    /**
     * System settings, containing miscellaneous Nameless system preferences. This table holds simple
    ...
    public static final class System extends Settings.NameValueTable {
        ...
        public static final String SYS_PROP_NAMELESS_SETTING_VERSION = "sys.n_settings_system_version";
        ...
        private static final NameValueCache sNameValueCache = new NameValueCache(
                SYS_PROP_NAMELESS_SETTING_VERSION,
                CONTENT_URI,
         ...
         * it throws {@link NamelessSettingNotFoundException}.
         *
         * @param cr The ContentResolver to access.
         * @param name The name of the setting to retrieve.
         *
         * @throws NamelessSettingNotFoundException Thrown if a setting by the given
         * name can't be found or the setting value is not an integer.
         *
         * @return The setting's current value.
         */
        public static int getInt(ContentResolver cr, String name)
                throws NamelessSettingNotFoundException {
        ...
        public static int getIntForUser(ContentResolver cr, String name, int userId)
            ...
            try {
                ...
                throw new NamelessSettingNotFoundException(name);
            }
        }
    ...
    /**
     * Secure settings, containing miscellaneous Nameless secure preferences. This
    ...
    public static final class Secure extends Settings.NameValueTable {
        ...
        public static final String SYS_PROP_NAMELESS_SETTING_VERSION = "sys.n_settings_secure_version";
    ...
    /**
     * Global settings, containing miscellaneous Nameless global preferences. This
     * table holds simple name/value pairs. There are convenience
     * functions for accessing individual settings entries.
     */
    public static final class Global extends Settings.NameValueTable {
        ...
        public static final String SYS_PROP_NAMELESS_SETTING_VERSION = "sys.n_settings_global_version";
